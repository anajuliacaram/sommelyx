...
export const InviteEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Você foi convidado(a) para a Sommelyx</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Você recebeu um convite para fazer parte da Sommelyx. Clique no botão abaixo para aceitar o convite e criar sua conta.
        </Text>
