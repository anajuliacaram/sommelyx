...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer select-none will-change-transform transition-all duration-200 ease-premium active:scale-[0.97]",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "rounded-2xl bg-[rgba(255,255,255,0.88)] text-[#1A1A1A] border border-[rgba(255,255,255,0.28)] shadow-[0_1px_3px_rgba(0,0,0,0.04)] backdrop-blur-md hover:bg-[rgba(255,255,255,0.94)] hover:-translate-y-[1px] hover:shadow-[0_4px_14px_rgba(0,0,0,0.10)] tracking-[-0.01em]",
        outline:
        ...
        ghost:
          "rounded-2xl bg-transparent text-foreground hover:bg-[rgba(255,255,255,0.12)]",
        danger:
