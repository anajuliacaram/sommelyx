  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed inset-0 z-50 flex items-center justify-center overflow-hidden p-3 sm:p-4",
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-serif text-[20px] sm:text-[28px] font-medium text-[#1d150f] leading-[1.15]",
      className,
    )}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-[14px] font-medium leading-6 tracking-[-0.01em] text-[rgba(58,51,39,0.66)] sm:text-[15px]", className)}
    {...props}
  />
));
