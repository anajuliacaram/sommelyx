...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[20px] text-card-foreground transition-[transform,box-shadow,background-color] duration-180 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[2px] hover:scale-[1.003] hover:bg-[rgba(255,255,255,0.68)] hover:shadow-[0_12px_28px_rgba(0,0,0,0.08)] active:scale-[0.99]",
      className,
    )}
    style={{
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex flex-col gap-3.5 p-5 pb-4 sm:p-6 sm:pb-5", className)} {...props} />
  ),
);
