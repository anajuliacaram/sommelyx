  ...
  if (isMobile) {
    return (
      ...
      <SheetContent
        ...
        data-mobile="true"
        className="w-[--sidebar-width] p-0 text-sidebar-foreground [&>button]:hidden !bg-[rgba(7,16,12,0.88)] !backdrop-blur-2xl !border-none !shadow-[0_20px_40px_-28px_rgba(0,0,0,0.5)]"
        style={
          {
