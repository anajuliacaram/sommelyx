  ...
  if (isMobile) {
    return (
      ...
      <SheetContent
        ...
        data-mobile="true"
        className="w-[--sidebar-width] p-0 text-sidebar-foreground [&>button]:hidden !bg-[rgba(10,20,15,0.92)] !backdrop-blur-xl !border-none !shadow-[0_20px_40px_-28px_rgba(0,0,0,0.5)]"
        style={
          {
