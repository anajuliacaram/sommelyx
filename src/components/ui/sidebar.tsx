...
const SIDEBAR_WIDTH_MOBILE = "min(68vw, 265px)";
    ...
    return (
      <div
        className={cn(
          ...
          "bg-transparent backdrop-blur-none border-r border-white/[0.06] shadow-none",
          className,
        )}
        ref={ref}
        {...props}
  ...
  if (isMobile) {
    return (
      ...
      <SheetContent
        ...
        className="mobile-sidebar-drawer w-[--sidebar-width] max-w-[265px] p-0 text-sidebar-foreground !bg-[#F6F4F1] !backdrop-blur-none !border-r !border-[rgba(95,111,82,0.10)] !shadow-[0_20px_40px_-28px_rgba(0,0,0,0.18)] overflow-hidden"
        style={
          {
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 h-full -translate-x-1/2 rounded-none bg-transparent p-0 text-transparent hover:bg-transparent transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hover:after:bg-sidebar-border sm:flex",
