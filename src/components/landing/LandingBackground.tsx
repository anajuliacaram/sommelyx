  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(123,30,43,0.10) 0%, transparent 70%)",
          filter: "blur(120px)",
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(20,60,50,0.15) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(123,30,43,0.06) 0%, transparent 70%)",
          filter: "blur(120px)",
        }}
      />
