...
export function LandingPricing({ onSignup }: LandingPricingProps) {
  return (
    <section id="pricing" className="relative px-5 sm:px-8 pt-16 sm:pt-24 pb-20 sm:pb-28 overflow-hidden z-10">
      ...
      <div className="mx-auto max-w-5xl relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[11px] font-bold tracking-wide uppercase mb-4 bg-[hsl(142_66%_95%)] text-[hsl(142_66%_28%)] border border-[hsl(142_66%_38%/0.15)]">
            ✔ 14 dias grátis
          </span>
        ...
        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 max-w-[800px] mx-auto items-stretch">
          {plans.map((plan, i) => (
            <motion.div
              key={plan.name}
