      ...
      <div className="mx-auto max-w-5xl relative z-10">
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 font-sans text-[13px] sm:text-[14px] font-medium text-[#2B2B2B]/60">
          ...
          <div className="mt-6">
            <Accordion type="single" collapsible className="w-full space-y-3">
              {faqs.map((item, idx) => (
	                ...
	                >
	                  <AccordionTrigger
	                    className="px-5 py-4 text-left font-sans text-[15px] sm:text-[16px] font-semibold tracking-[-0.01em] leading-snug text-[#2B2B2B] hover:no-underline [&>svg]:text-[#2B2B2B]/40 [&[data-state=open]>svg]:text-[#6E1E2A] data-[state=open]:text-[#6E1E2A]"
	                  >
	                    {item.q}
	                  </AccordionTrigger>
