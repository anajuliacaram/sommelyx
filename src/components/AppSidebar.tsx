        ...
        <SidebarHeader className="pt-3 md:pt-3 px-3">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-[17px] font-bold tracking-[-0.01em] text-primary leading-none font-serif mx-0 px-0 border-solid opacity-100 shadow-sm text-left mr-0 border-white">
                Sommelyx
              </span>
              <span
                className={[
