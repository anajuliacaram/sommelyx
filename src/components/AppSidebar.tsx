    ...
    <>
      <Sidebar collapsible="offcanvas" className="border-r border-border w-[240px]" style={{ background: "hsl(var(--sidebar-background))" }}>
        <SidebarHeader className="pt-3 md:pt-3 px-3">
          ...
          >
            <div className="relative flex h-[64px] w-[44px] shrink-0 items-center justify-center overflow-hidden rounded-lg">
              <Logo
                variant="compact"
                className="h-[64px] w-auto object-contain drop-shadow-[0_6px_12px_rgba(15,15,20,0.18)]"
              />
            </div>
            <div className="flex flex-col">
              <span className="text-[17px] font-bold tracking-[-0.01em] text-primary leading-none font-serif">
                Sommelyx
              </span>
              <span
                className={[
