      ...
      <Sidebar collapsible="offcanvas" className="border-r border-border w-[240px]" style={{ background: "hsl(var(--sidebar-background))" }}>
        <SidebarHeader className="pt-4 md:pt-4 px-3">
          <Link
            ...
            className="flex items-center gap-3.5 px-1 py-2 mb-3 rounded-lg transition-colors hover:bg-muted/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/15"
            aria-label="Ir para o início do dashboard"
          >
            <Logo
              variant="compact"
              className="h-[56px] w-[40px] min-w-[40px] object-contain drop-shadow-[0_2px_8px_rgba(15,15,20,0.15)]"
            />
