  ...
  return (
    <div className="space-y-7 max-w-6xl">
      <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
        ...
        <p className="text-sm text-muted-foreground mt-1">Resumo da sua adega pessoal</p>
      </motion.div>
        ...
        {metrics.map((m, i) => (
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              {m.change && (
                <span className="text-[11px] text-accent flex items-center gap-0.5 font-medium">
