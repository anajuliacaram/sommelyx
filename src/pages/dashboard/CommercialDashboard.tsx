              ...
              <motion.div className="col-span-12 lg:col-span-7" initial="hidden" animate="visible" variants={fadeUp} custom={1}>
                <div className="glass-card p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Button variant="outline" className="h-9 rounded-2xl text-[12px] font-black uppercase tracking-[0.12em]" onClick={() => navigate("/dashboard/inventory")}>
                      Ver estoque
                    </Button>
                  </div>
                    ...
                    <div className="divide-y divide-black/[0.06]">
                      {stockRows.map((row) => (
                        <button
                          ...
                          className="grid w-full grid-cols-12 items-center gap-2 px-3 py-2.5 text-left transition-colors hover:bg-black/[0.03]"
                        >
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      {[
                        ...
                        <button
                          ...
                          className="flex h-11 items-center gap-2 rounded-2xl border border-black/[0.06] bg-white/70 px-3 text-left transition-all hover:-translate-y-0.5 hover:bg-white/80"
                        >
