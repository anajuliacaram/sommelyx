      ...
      <div className="max-w-[1280px] space-y-4">
        ...
        {isFiltered && !filtersOpen && (
          <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }}>
            <div className="flex items-center gap-2 flex-wrap rounded-xl border border-primary/15 bg-primary/[0.03] px-4 py-2.5">
              <span className="text-[11px] font-semibold text-muted-foreground shrink-0">Visualizando:</span>
              ...
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                <div className="glass-card p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-[16px] font-bold tracking-[-0.01em] text-foreground">Por tipo</h3>
                  </div>
                ...
                <div className="glass-card p-6">
                  <div className="flex items-center gap-2 mb-4">
                    <BarChart3 className="h-4 w-4 text-muted-foreground/40" />
                    <h3 className="text-[16px] font-bold tracking-[-0.01em] text-foreground">Por região</h3>
                  </div>
                  ...
                  <div className="h-[170px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={salesMonthly}>
                        ...
                        <YAxis tick={{ fontSize: 11, fill: "hsl(var(--muted-foreground)/0.4)" }} axisLine={false} tickLine={false} width={30} />
                  ...
                  <div className="h-[170px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={stockMovesMonthly}>
                        ...
                        <Bar dataKey="in" stackId="a" radius={[6, 6, 0, 0]} fill="hsl(var(--accent))" name="Entrada" />
                        <Bar dataKey="out" stackId="a" radius={[6, 6, 0, 0]} fill="hsl(var(--primary))" name="Saída" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                  ...
                  <div className="h-[170px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={stockMovesMonthly}>
                        ...
                        <YAxis tick={{ fontSize: 11, fill: "hsl(var(--muted-foreground)/0.4)" }} axisLine={false} tickLine={false} width={30} />
                        <Tooltip contentStyle={chartTooltipStyle} />
                        <Area type="monotone" dataKey="net" stroke="hsl(var(--primary))" fill="hsl(var(--primary) / 0.06)" strokeWidth={2} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
