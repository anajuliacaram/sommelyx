...
export default function TermsOfService() {
  const toc = [
    ...
    { id: "plataforma-oferece", title: "O que a plataforma oferece" },
    { id: "conta-acesso", title: "Conta e acesso" },
    { id: "conteudo-usuario", title: "Conteúdo enviado pelo usuário" },
    { id: "uso-ia", title: "Uso de IA" },
    { id: "uso-comercial", title: "Uso comercial" },
    { id: "uso-permitido", title: "Uso permitido" },
    { id: "assinaturas-planos", title: "Assinaturas e planos" },
    { id: "disponibilidade-seguranca", title: "Disponibilidade e segurança" },
  ...
  return (
    ...
    >
      ...
      <LegalSectionCard id="quem-somos">
        <h2>1. Quem somos</h2>
        <p>
      ...
      <LegalSectionCard id="plataforma-oferece">
      ...
      <LegalSectionCard id="conta-acesso">
      ...
      <LegalSectionCard id="conteudo-usuario">
      ...
      <LegalSectionCard id="uso-permitido">
      ...
      <LegalSectionCard id="assinaturas-planos">
      ...
      <LegalSectionCard id="disponibilidade-seguranca">
      ...
      <LegalSectionCard id="limitacao-responsabilidade">
      ...
      <LegalSectionCard id="encerramento">
