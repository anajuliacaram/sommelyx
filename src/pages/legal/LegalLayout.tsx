  ...
  return (
    <div className="legal-shell min-h-[100dvh] text-[#1C1C1C]">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-8">
        <header className="legal-hero rounded-[32px] px-5 py-4 sm:px-8 sm:py-6 lg:px-10 lg:py-7">
          <div className="relative z-10">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <Link
                to="/"
                className="inline-flex items-center gap-3 rounded-[24px] border border-white/65 bg-white/65 px-3.5 py-2.5 shadow-[0_14px_36px_-28px_rgba(20,18,16,0.22)] transition-transform duration-200 hover:-translate-y-[1px] hover:bg-white/85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7B1E2B]/15"
              >
                <Logo
                  variant="compact"
                  className="h-9 w-auto shrink-0 drop-shadow-[0_2px_8px_rgba(15,15,20,0.12)]"
                />
                <span className="flex min-w-0 flex-col leading-none">
                  <BrandName className="text-[18px] sm:text-[21px]" />
            ...
            <div className="mt-4 max-w-4xl">
              ...
              <h1 className="mt-2.5 text-[34px] font-semibold tracking-[-0.06em] text-[#181818] sm:text-[48px] lg:text-[58px]">
                {title}
              </h1>
              <p className="mt-3 max-w-3xl text-[15px] leading-8 text-[#5F5F5F] sm:text-[16px] sm:leading-9">
                {description}
              </p>
            </div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-12">
          ...
          {toc ? (
            <aside className="hidden lg:block lg:self-start">
              <nav className="legal-sidebar-card sticky top-[112px]">
