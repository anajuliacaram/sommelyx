...
const plans = [
  {
    ...
    features: ["Garrafas ilimitadas", "Alerta de consumo ideal", "Histórico e notas de degustação", "Insights da sua adega"],
  ...
  },
  {
    ...
    features: ["Tudo do Pro incluído", "Gestão completa de estoque", "Controle de vendas", "Relatórios financeiros e curva ABC"],
    cta: "Testar grátis por 14 dias",
